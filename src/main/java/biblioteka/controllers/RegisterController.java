...
public class RegisterController {
	...
	public String registerPost(@RequestParam(value="username", defaultValue="") String username, @RequestParam(value="password", defaultValue="") String password, @RequestParam(value="firstname", defaultValue="") String firstname, @RequestParam(value="lastname", defaultValue="") String lastname, Model model, HttpServletRequest request) {
		...
		if (account == null){
			accountsRepository.save(new Account(username, password, Role.ROLE_USER, firstname, lastname));
